 ...
 * Include this file after the 'WP_Settings_Demo_Settings' class is included.
 * Only include this class in development code.
 *
 * @uses Uses the 'wp_settings_demo_debug' filter from the 'WP_Settings_Demo_Settings' class.
	...
	class WP_Settings_Demo_Debug {
		...
		public function __construct() {
			if ( class_exists( 'WP_Settings_Demo_Settings' ) ) {
				...
				add_filter( 'wp_settings_demo_debug', array( $this, 'is_valid_admin_page' ), 10, 4 );
			}
		}
